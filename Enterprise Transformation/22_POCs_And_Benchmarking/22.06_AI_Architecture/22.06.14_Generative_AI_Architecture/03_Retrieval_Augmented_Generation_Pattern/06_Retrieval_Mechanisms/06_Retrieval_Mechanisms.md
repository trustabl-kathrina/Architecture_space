...
## 20. ADR Reference
- [ADR-AI-006: Adoption of Hybrid Search and Re-ranking for Enterprise RAG](../01.17_ADR/ADR-AI-006-Hybrid_Search_Reranking.md) *(Placeholder)*
- [ADR-AI-007: Standardizing Azure AI Search as the Default Enterprise Retrieval Engine](../01.17_ADR/ADR-AI-007-Azure_AI_Search.md) *(Placeholder)*
