...
## 20. ADR Reference
- [ADR-AI-005: Vector Database Selection for Enterprise RAG](../01.17_ADR/ADR-AI-005-Vector_Database_Selection.md) *(Placeholder)*
- [ADR-DA-012: Standardization on PostgreSQL pgvector for Low-Volume Embeddings](../../03_Data_Architecture/03.20_ADR/ADR-DA-012-pgvector.md) *(Placeholder)*
