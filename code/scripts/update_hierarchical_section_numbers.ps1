...
$Replacements = @(
    ...
    @{ Pattern = '(?i)\bsection 03\b'; Replacement = '02.05' }
    @{ Pattern = '(?i)\bsection 08\.03\b'; Replacement = '08.10' }
    @{ Pattern = '\| 09 \|'; Replacement = '| 02.01.02 |' }
    @{ Pattern = '\| 10 \| Data Storage'; Replacement = '| 02.05 | Data Storage' }
    ...
    @{ Pattern = '\| 03 \| Data Storage'; Replacement = '| 02.05 | Data Storage' }
    ...
    @{ Pattern = 'Legacy section numbers \*\*03, 07, 09, 10, 12\*\*'; Replacement = 'Nested domain IDs **00.10, 02.05, 02.07, 08.10, 11.12**' }
    @{ Pattern = 'Legacy section numbers \(03, 07, 09, 10, 12\)'; Replacement = 'hierarchical domain IDs (00.10, 02.05, 02.07, 08.10, 11.12)' }
    ...
    @{ Pattern = 'id: "03"'; Replacement = 'id: "02.05"' }
