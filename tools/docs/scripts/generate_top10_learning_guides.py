...
BASE = os.path.normpath(
    os.path.join(os.path.dirname(__file__), "..", "..", "docs",
                 ...
                 "03_Data_Orchestration_Architecture", "03_Top_10")
)

# Open-source / self-hosted only — cloud managed services live in 02_Cloud_Services
TECHS = [
    {"id": "02.03.03.02", "folder": "02_Apache_Airflow_Learning_Guide", "rank": 1,
    ...
    {"id": "02.03.03.03", "folder": "03_Prefect_Learning_Guide", "rank": 2,
    ...
    {"id": "02.03.03.04", "folder": "04_Dagster_Learning_Guide", "rank": 3,
    ...
    {"id": "02.03.03.05", "folder": "05_Temporal_Learning_Guide", "rank": 4,
    ...
    {"id": "02.03.03.06", "folder": "06_Argo_Workflows_Learning_Guide", "rank": 5,
    ...
    {"id": "02.03.03.07", "folder": "07_Kestra_Learning_Guide", "rank": 6,
    ...
    {"id": "02.03.03.08", "folder": "08_Flyte_Learning_Guide", "rank": 7,
    ...
    {"id": "02.03.03.09", "folder": "09_Luigi_Learning_Guide", "rank": 8,
    ...
    {"id": "02.03.03.10", "folder": "10_Metaflow_Learning_Guide", "rank": 9,
    ...
    {"id": "02.03.03.11", "folder": "11_Mage_Learning_Guide", "rank": 10,
...
def write_readme(t):
    ...
    content = (frontmatter(f"{t['name']} Learning Guide", t["section"], "hub", t["tags"])
        ...
        f"> **Rank #{t['rank']}** in [Top 10 Open Source Orchestration](../01_Overview/01_Top_10_Orchestration_Technologies.md).\n\n"
        f"Structured learning path for **{t['desc']}**.\n\n"
        f"For managed cloud orchestrators (Composer, MWAA, ADF, Step Functions, Workflows), see "
        f"[02.03.02 Cloud Services](../../02_Cloud_Services/README.md).\n\n"
        "## Prerequisites\n\n"
        f"- {t['prereq']}\n"
        "- [Top 10 rankings](../01_Overview/01_Top_10_Orchestration_Technologies.md)\n\n"
        "## Modules\n\n| # | Module | Focus |\n| ---: | --- | --- |\n"
        f"{mod_rows}\n\n## Quick links\n\n"
...
Ranked in [Top 10 Open Source Orchestration](../01_Overview/01_Top_10_Orchestration_Technologies.md) for adoption in data engineering, OSS community, and production fit — **excluding** hyperscaler managed services covered in [Cloud Services](../../02_Cloud_Services/README.md).

## When to use {t['short']}

| Use when… | Consider alternatives when… |
| --- | --- |
| {t['category']} matches your platform strategy | Managed cloud-only standard → [Cloud Services](../../02_Cloud_Services/README.md) |
...
See [official architecture docs]({t['docs']}) and [orchestration reference model](../../01_Fundamentals/01_Overview/03_Orchestration_Reference_Model.md).
...
See [Orchestration Strategy](../../01_Fundamentals/02_Strategy/01_Orchestration_Strategy.md).
""",
...
Compare [Top 10 peers](../README.md) and [Cloud Services](../../02_Cloud_Services/README.md) for managed alternatives.
""",
...
Self-hosted Airflow on 3-node K8s vs managed Composer — see [Managed Workflows comparison](../../02_Cloud_Services/01_Overview/02_Managed_Workflows.md).
""",
...
Managed cloud scorecards: [Cloud Services learning guides](../../02_Cloud_Services/README.md).
""",
