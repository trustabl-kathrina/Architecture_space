...
- Cross-link from section 02 `What_Is_Data_Engineering` updated to `01_Fundamentals/02_Strategy/02_Streaming_Strategy.md`
- Agent/MCP content removed from 02.07 (canonical in 11.12)

## Scripts

- `tools/docs/scripts/consolidate_section_09.ps1`
- `tools/docs/scripts/fix_section_09_numbering.ps1` (topic-group folders)
- `tools/docs/scripts/number_section_09_files.ps1` (sequenced topic filenames)
...
- Topic groups: `02.01.02.SS.TT.NN_Topic_Name.md` (e.g. `01_What_Is_Event_Driven_Architecture.md`)
- Flat subsections: `02.01.02.SS.NN_Topic_Name.md` (e.g. `01_Streaming_Design_Patterns.md`)
