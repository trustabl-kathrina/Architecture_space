...
| Nested domain | `02.07` | `02.01_Data_Ingestion_Architecture/02.01.02_Streaming/` |
| Subsection | `02.01.02.01` | `02.01.02.01_Fundamentals/` |
| Topic group | `02.01.02.01.01` | `02.01.02.01.01_Overview/` |
...
- `code/scripts/apply_parent_hierarchy.ps1` — folder renames, internal prefix renumbering, link and front matter updates
- `code/scripts/repair_parent_hierarchy_link_damage.ps1` — fixes cross-prefix corruption
- `code/scripts/update_hierarchical_section_numbers.ps1` — retires legacy section number prose references
