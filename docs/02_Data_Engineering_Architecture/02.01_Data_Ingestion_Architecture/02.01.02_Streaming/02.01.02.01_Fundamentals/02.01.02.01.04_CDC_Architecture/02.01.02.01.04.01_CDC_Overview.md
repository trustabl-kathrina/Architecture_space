...
- Schema evolution must align with [Event Contracts](../../02.01.02.08_Integration_Patterns/02.01.02.08.04_Event_Contracts.md).
- Pipeline ingestion entry patterns live in section 02; CDC **streaming path** is canonical here.

## Related

- [Change Data Capture Patterns](02.01.02.01.04.02_Change_Data_Capture_Patterns.md)
- [Debezium Architecture](02.01.02.01.04.04_Debezium_Architecture.md)
- [Outbox Pattern](02.01.02.01.04.03_Outbox_Pattern.md)
