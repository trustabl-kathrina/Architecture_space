...
- [CDC Overview](../../02.01.02.01_Fundamentals/02.01.02.01.04_CDC_Architecture/02.01.02.01.04.01_CDC_Overview.md)
- [Lakehouse Architecture](../../../02_Data_Engineering_Architecture/02.05_Data_Storage_Architecture/02.05.03_Lakehouse/Lakehouse_Architecture.md)
- [Real-Time Analytics Architecture](../../../08_Analytics_Architecture/08.10_Real_Time_Analytics_Architecture/08.10.05_Streaming_Analytics/Real_Time_Analytics_Architecture.md)
