...
- Long-running business processes with compensations ([Saga Pattern](02.01.02.04.03_Integration_Patterns/02.01.02.04.03.02_Saga_Pattern.md)).
...
- [Saga Pattern](../02.01.02.04.03_Integration_Patterns/02.01.02.04.03.02_Saga_Pattern.md)
- [Event Driven Microservices](../../02.01.02.08_Integration_Patterns/02.01.02.08.08_Event_Driven_Microservices.md)
