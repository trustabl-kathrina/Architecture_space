...
Pub/Sub handles **transport**; Dataflow handles **computation**. See [Pub/Sub Learning Guide](../02.01.02.02.02.04_Pub_Sub_Learning_Guide/README.md) for messaging depth.
...
Continue to [Architecture](02.01.02.02.02.05.02_Architecture.md) or jump to [Scenarios](02.01.02.02.02.05.04_Scenarios.md).
