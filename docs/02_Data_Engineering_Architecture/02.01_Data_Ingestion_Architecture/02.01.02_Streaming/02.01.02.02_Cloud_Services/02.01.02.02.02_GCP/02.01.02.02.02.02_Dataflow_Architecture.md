...
For hands-on depth — usage, scenarios, limits, costing, configuration recipes, evaluation, and benchmarks — see the [Dataflow Learning Guide](02.01.02.02.02.05_Dataflow_Learning_Guide/README.md).

## Related

- [Pub/Sub Architecture](02.01.02.02.02.01_Pub_Sub_Architecture.md)
- [Beam Dataflow Model](../../../02.01.02.03_Open_Source/02.01.02.03.06_Beam/02.01.02.03.06.01_Beam_Dataflow_Model.md)
- [Flink Architecture](../../../02.01.02.03_Open_Source/02.01.02.03.04_Apache_Flink/02.01.02.03.04.01_Flink_Architecture.md)
- [Streaming to Lakehouse](../../../02.01.02.04_Architecture_Patterns/02.01.02.04.05_Reference_Architectures/02.01.02.04.05.03_Streaming_To_Lakehouse.md)
