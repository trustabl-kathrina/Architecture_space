---
title: AWS Managed Flink How To Use
...
canonical: true
---
# 3. AWS Managed Flink How To Use
...
## IAM checklist (02.02.02.03.06 AWS Managed Flink)
...
./deploy.sh --job 02.02.02.03.06_AWS_Managed_Flink_silver_merge
```
