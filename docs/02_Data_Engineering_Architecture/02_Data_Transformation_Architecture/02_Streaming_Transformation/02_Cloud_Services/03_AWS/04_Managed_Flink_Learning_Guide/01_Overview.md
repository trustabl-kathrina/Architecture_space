...
**Amazon Managed Service for Apache Flink** is AWS-managed Flink for Kinesis and MSK stream transformation.
...
Continue to [Architecture](02.02_Architecture.md) or [Scenarios](02.04_Scenarios.md).
