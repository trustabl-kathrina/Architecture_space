---
title: Azure Stream Analytics How To Use
...
canonical: true
---
# 3. Azure Stream Analytics How To Use
...
## IAM checklist (02.02.02.03.07 Azure Stream Analytics)
...
./deploy.sh --job 02.02.02.03.07_Azure_Stream_Analytics_silver_merge
```
