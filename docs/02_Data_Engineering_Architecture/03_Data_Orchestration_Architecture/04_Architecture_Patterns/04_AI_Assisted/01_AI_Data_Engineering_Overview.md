...
| Doc | Focus |
| --- | --- |
| [Agentic Data Engineering](02_Agentic_Data_Engineering.md) | Autonomous agents in workflows |
| [AI Code Generation](03_AI_Code_Generation.md) | Task and DAG codegen |
| [AI Pipeline Generation](08_AI_Pipeline_Generation.md) | End-to-end pipeline drafts |
| [Autonomous Data Platforms](10_Autonomous_Data_Platforms.md) | Vision and limits |

## Related

- [Orchestration Strategy](../../01_Fundamentals/02_Strategy/01_Orchestration_Strategy.md)
- [Metadata-Driven Framework](../02_Metadata_Driven/01_Metadata_Driven_Framework.md)
