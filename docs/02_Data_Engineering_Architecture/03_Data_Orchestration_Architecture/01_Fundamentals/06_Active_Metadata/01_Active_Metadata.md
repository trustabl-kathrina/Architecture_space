...
Enforce via [Orchestration Governance](../04_Governance/01_Orchestration_Governance.md) CI checks.
...
Active metadata is the **runtime nervous system**; [metadata-driven pipelines](../../04_Architecture_Patterns/02_Metadata_Driven/01_Metadata_Driven_Framework.md) are the **generation blueprint**. Together:

- **Define** pipelines from metadata (config-driven).
- **Operate** pipelines via metadata events (active metadata).

See also [Metadata Orchestration](../../04_Architecture_Patterns/02_Metadata_Driven/07_Metadata_Orchestration.md).

## Related

- [Scheduling Patterns](../03_Core_Concepts/01_Scheduling_Patterns.md)
- [Dependency Management](../03_Core_Concepts/02_Dependency_Management.md)
- [Metadata Reference Architecture](../../09_Reference_Architectures/01_Metadata_Reference_Architecture.md)
- [AI Metadata Management](../../04_Architecture_Patterns/04_AI_Assisted/07_AI_Metadata_Management.md)
