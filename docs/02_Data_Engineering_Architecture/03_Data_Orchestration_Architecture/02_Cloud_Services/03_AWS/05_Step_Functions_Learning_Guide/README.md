...
| # | Module | Focus |
| ---: | --- | --- |
| 1 | [Overview](01_Overview.md) | What Step Functions is, Standard vs Express, vs MWAA |
| 2 | [Architecture](02_Architecture.md) | State machines, executions, ASL, integrations |
| 3 | [How to Use](03_How_To_Use.md) | Author ASL, deploy, invoke, IAM |
| 4 | [Scenarios](04_Scenarios.md) | Event-driven and data pipeline patterns |
| 5 | [Limitations and Scenarios](05_Limitations_And_Scenarios.md) | Quotas, payload limits, mitigations |
| 6 | [Costing](06_Costing.md) | Standard vs Express pricing, scenario models |
| 7 | [Production Configuration](07_Production_Configuration.md) | Retry, Map, callbacks, EventBridge, monitoring |
| 8 | [Evaluation Criteria](08_Evaluation_Criteria.md) | Scorecard vs MWAA, Cloud Workflows, Logic Apps |
