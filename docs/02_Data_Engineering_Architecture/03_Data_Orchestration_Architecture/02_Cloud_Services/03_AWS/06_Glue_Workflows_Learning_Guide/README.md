...
| # | Module | Focus |
| ---: | --- | --- |
| 1 | [Overview](01_Overview.md) | What Glue Workflows is, vs MWAA/Step Functions |
| 2 | [Architecture](02_Architecture.md) | Workflows, triggers, jobs, crawlers, catalog |
| 3 | [How to Use](03_How_To_Use.md) | Create workflow, triggers, run properties, IAM |
| 4 | [Scenarios](04_Scenarios.md) | Medallion, incremental, conditional promote patterns |
| 5 | [Limitations and Scenarios](05_Limitations_And_Scenarios.md) | 100-entity limit, scope, mitigations |
| 6 | [Costing](06_Costing.md) | DPU billing, Flex vs Standard, scenario models |
| 7 | [Production Configuration](07_Production_Configuration.md) | Concurrency, bookmarks, monitoring, hybrid |
| 8 | [Evaluation Criteria](08_Evaluation_Criteria.md) | Scorecard vs MWAA, Step Functions, Glue-only fit |
| 9 | [Benchmarking](09_Benchmarking.md) | Reference workflow profiles |
