...
All modes use hierarchical IDs aligned with `02_Streaming`:
...
| --- | --- | --- | --- |
| 02.01.01 | [Batch Ingestion](01_Batch_Ingestion/README.md) | `02.01.01_*` | Scheduled bulk loads, file landing zones, ETL/ELT batch connectors |
| 02.01.02 | [Streaming](02_Streaming/README.md) | `02.01.02_*` | Event-driven architecture, Kafka/Pub/Sub, CDC, stream processing, benchmarks |
| 02.01.03 | [Near-Real-Time Ingestion](03_Near_Real_Time_Ingestion/README.md) | `02.01.03_*` | Micro-batch, latency-sensitive pipelines between batch and streaming |

## Shared foundations

| # | Topic | Path | Description |
| --- | --- | --- | --- |
| 02.01.04 | [Shared Foundations](04_Shared_Foundations/README.md) | `02.01.04_*` | Vision, strategy, pipeline architecture, enterprise frameworks, cross-mode ingestion |
