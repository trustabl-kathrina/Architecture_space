...
Pub/Sub handles **transport**; Dataflow handles **computation**. See [Pub/Sub Learning Guide](../04_Pub_Sub_Learning_Guide/README.md) for messaging depth.
...
Continue to [Architecture](02_Architecture.md) or jump to [Scenarios](04_Scenarios.md).
