...
- **Lineage** from source topic → job → sink (link to 00.10.03).
- **Replay runbooks** — documented offset reset procedures with approval gates.
- **SLO dashboards** tied to [Stream SLA Framework](04_Stream_SLA_Framework.md).

## Related

- [EventOps Framework](01_EventOps_Framework.md)
- [Watermarks](../../../05_Benchmarks/02_Watermarks.md)
- [Data Observability](../../../02_Data_Engineering_Architecture/04_Data_Observability_Architecture/README.md)
