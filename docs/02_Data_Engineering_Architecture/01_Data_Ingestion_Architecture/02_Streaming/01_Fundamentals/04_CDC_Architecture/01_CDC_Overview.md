...
- Schema evolution must align with [Event Contracts](../../08_Integration_Patterns/04_Event_Contracts.md).
- Pipeline ingestion entry patterns live in section 02; CDC **streaming path** is canonical here.

## Related

- [Change Data Capture Patterns](02_Change_Data_Capture_Patterns.md)
- [Debezium Architecture](04_Debezium_Architecture.md)
- [Outbox Pattern](03_Outbox_Pattern.md)
