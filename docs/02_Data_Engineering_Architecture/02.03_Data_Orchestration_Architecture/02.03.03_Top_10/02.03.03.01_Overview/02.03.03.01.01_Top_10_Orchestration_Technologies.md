...
A **ranked shortlist of open source and self-hosted orchestration platforms** for data engineering — **excluding** hyperscaler managed services (Composer, MWAA, ADF, Step Functions, Cloud Workflows), which are documented in [02.03.02 Cloud Services](../../02.03.02_Cloud_Services/README.md).
...
**Guide:** [Apache Airflow Learning Guide](../02.03.03.02_Apache_Airflow_Learning_Guide/README.md)

### 2. Prefect

**Category:** Modern Python orchestration  
**Why #2:** Dynamic flows, hybrid agents, strong DX; alternative to Airflow rigidity.  
**Guide:** [Prefect Learning Guide](../02.03.03.03_Prefect_Learning_Guide/README.md)
...
**Guide:** [Dagster Learning Guide](../02.03.03.04_Dagster_Learning_Guide/README.md)
...
**Guide:** [Temporal Learning Guide](../02.03.03.05_Temporal_Learning_Guide/README.md)

### 5. Argo Workflows

**Category:** Kubernetes-native (CNCF)  
**Why #5:** Container-first batch on K8s; standard for ML platforms and Spark-on-K8s estates.  
**Guide:** [Argo Workflows Learning Guide](../02.03.03.06_Argo_Workflows_Learning_Guide/README.md)
...
**Guide:** [Kestra Learning Guide](../02.03.03.07_Kestra_Learning_Guide/README.md)

### 7. Flyte

**Category:** K8s data/ML orchestrator  
**Why #7:** Strongly typed Python tasks, caching, and reproducibility for data + ML on Kubernetes.  
**Guide:** [Flyte Learning Guide](../02.03.03.08_Flyte_Learning_Guide/README.md)
...
**Guide:** [Luigi Learning Guide](../02.03.03.09_Luigi_Learning_Guide/README.md)
...
**Guide:** [Metaflow Learning Guide](../02.03.03.10_Metaflow_Learning_Guide/README.md)
...
**Guide:** [Mage Learning Guide](../02.03.03.11_Mage_Learning_Guide/README.md)

## Managed cloud orchestrators (not in this Top 10)

Documented under [Cloud Services](../../02.03.02_Cloud_Services/README.md):

| Service | Cloud | Learning guide |
| --- | --- | --- |
| Cloud Composer | GCP | [Guide](../../02.03.02_Cloud_Services/02.03.02.02_GCP/02.03.02.02.03_Cloud_Composer_Learning_Guide/README.md) |
| Cloud Workflows | GCP | [Guide](../../02.03.02_Cloud_Services/02.03.02.02_GCP/02.03.02.02.04_Cloud_Workflows_Learning_Guide/README.md) |
| Amazon MWAA | AWS | [Guide](../../02.03.02_Cloud_Services/02.03.02.03_AWS/02.03.02.03.04_MWAA_Learning_Guide/README.md) |
| AWS Step Functions | AWS | [Guide](../../02.03.02_Cloud_Services/02.03.02.03_AWS/02.03.02.03.05_Step_Functions_Learning_Guide/README.md) |
| AWS Glue Workflows | AWS | [Guide](../../02.03.02_Cloud_Services/02.03.02.03_AWS/02.03.02.03.06_Glue_Workflows_Learning_Guide/README.md) |
| Azure Data Factory | Azure | [Guide](../../02.03.02_Cloud_Services/02.03.02.04_Azure/02.03.02.04.03_Azure_Data_Factory_Learning_Guide/README.md) |
| Azure Logic Apps | Azure | [Guide](../../02.03.02_Cloud_Services/02.03.02.04_Azure/02.03.02.04.04_Logic_Apps_Learning_Guide/README.md) |
