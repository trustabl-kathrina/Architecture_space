...
| --- | --- | --- | --- |
| **GCP** | Cloud Composer | Managed Airflow | [Architecture](../02.03.02.02_GCP/02.03.02.02.01_Cloud_Composer_Architecture.md) |
| **GCP** | Cloud Workflows | Serverless | [Architecture](../02.03.02.02_GCP/02.03.02.02.02_Cloud_Workflows_Architecture.md) |
| **AWS** | MWAA | Managed Airflow | [Architecture](../02.03.02.03_AWS/02.03.02.03.01_MWAA_Architecture.md) |
| **AWS** | Step Functions | Serverless | [Architecture](../02.03.02.03_AWS/02.03.02.03.02_Step_Functions_Architecture.md) |
| **AWS** | Glue Workflows | Analytics jobs | [Architecture](../02.03.02.03_AWS/02.03.02.03.03_Glue_Workflows_Architecture.md) |
| **Azure** | Azure Data Factory | Data factory | [Architecture](../02.03.02.04_Azure/02.03.02.04.01_Azure_Data_Factory_Architecture.md) |
| **Azure** | Logic Apps | Serverless / integration | [Architecture](../02.03.02.04_Azure/02.03.02.04.02_Logic_Apps_Architecture.md) |
...
Full catalog: [Cloud Orchestration Reference Architecture](02.03.02.01.01_Cloud_Orchestration_Reference_Architecture.md).
