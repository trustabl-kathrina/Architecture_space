...
| --- | --- | --- |
| [**Cloud Composer**](../02.03.02.02_GCP/02.03.02.02.01_Cloud_Composer_Architecture.md) | Managed Airflow | Managed Apache Airflow on GKE; primary GCP batch orchestrator |
| [**Cloud Workflows**](../02.03.02.02_GCP/02.03.02.02.02_Cloud_Workflows_Architecture.md) | Serverless workflow | HTTP/gRPC steps, connectors, long-running serverless orchestration |
...
| Service | Category | Description |
| --- | --- | --- |
| [**MWAA**](../02.03.02.03_AWS/02.03.02.03.01_MWAA_Architecture.md) | Managed Airflow | Managed Workflows for Apache Airflow on AWS |
| [**Step Functions**](../02.03.02.03_AWS/02.03.02.03.02_Step_Functions_Architecture.md) | Serverless workflow | State machines; Standard and Express workflows |
| [**Glue Workflows**](../02.03.02.03_AWS/02.03.02.03.03_Glue_Workflows_Architecture.md) | Job workflow | Orchestrate Glue crawlers, jobs, triggers inside AWS Glue |
...
| Service | Category | Description |
| --- | --- | --- |
| [**Azure Data Factory (ADF)**](../02.03.02.04_Azure/02.03.02.04.01_Azure_Data_Factory_Architecture.md) | Data factory | Pipeline activities, triggers, SSIS/IR integration, Fabric alignment |
| [**Logic Apps**](../02.03.02.04_Azure/02.03.02.04.02_Logic_Apps_Architecture.md) | Serverless workflow | Connector-based workflows, enterprise integration patterns |
...
See [Managed Workflows](02.03.02.01.02_Managed_Workflows.md) for detailed comparison of managed offerings.
...
- [Managed Workflows](02.03.02.01.02_Managed_Workflows.md)
...
- [Cloud Composer](../02.03.02.02_GCP/02.03.02.02.01_Cloud_Composer_Architecture.md)
...
- [Glue Workflows Learning Guide](../02.03.02.03_AWS/02.03.02.03.06_Glue_Workflows_Learning_Guide/README.md)
- [ADF Learning Guide](../02.03.02.04_Azure/02.03.02.04.03_Azure_Data_Factory_Learning_Guide/README.md)
- [Logic Apps Learning Guide](../02.03.02.04_Azure/02.03.02.04.04_Logic_Apps_Learning_Guide/README.md)
- [MWAA Learning Guide](../02.03.02.03_AWS/02.03.02.03.04_MWAA_Learning_Guide/README.md)
- [Step Functions Learning Guide](../02.03.02.03_AWS/02.03.02.03.05_Step_Functions_Learning_Guide/README.md)
- [MWAA](../02.03.02.03_AWS/02.03.02.03.01_MWAA_Architecture.md)
- [Azure Data Factory](../02.03.02.04_Azure/02.03.02.04.01_Azure_Data_Factory_Architecture.md)
- [Multi-Cloud Orchestration Patterns](../02.03.02.05_Cross_Cloud/02.03.02.05.01_Multi_Cloud_Orchestration_Patterns.md)
