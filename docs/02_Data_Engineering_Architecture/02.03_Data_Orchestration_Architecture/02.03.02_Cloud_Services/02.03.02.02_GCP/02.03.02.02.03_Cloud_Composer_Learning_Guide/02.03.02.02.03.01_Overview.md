...
| **Composer 3** | **Recommended** for new environments | Improved scaling; **DCU-based** billing (see [Costing](02.03.02.02.03.06_Costing.md)); Airflow 2.x+ |
...
See [Cloud Workflows Learning Guide](../02.03.02.02.04_Cloud_Workflows_Learning_Guide/README.md) for complementary serverless patterns.
...
Continue to [Architecture](02.03.02.02.03.02_Architecture.md) for component design, or [Scenarios](02.03.02.02.03.04_Scenarios.md) for enterprise pipeline patterns.
