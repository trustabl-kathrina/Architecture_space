...
| 05 | [Data Modeling Architecture](05_Data_Modeling_Architecture/README.md) | `05_*` | Conceptual, logical, physical, dimensional, Data Vault, canonical, and semantic modeling. |
