...
Features computed from scheduled SQL, Spark, or dbt jobs over warehouse/lake tables. This topic is part of **08.05 Feature Store Architecture** under `05_Feature_Engineering`.
...
Extend this diagram for `Batch Features`-specific components, storage engines, and control-plane integrations as the topic is elaborated.
