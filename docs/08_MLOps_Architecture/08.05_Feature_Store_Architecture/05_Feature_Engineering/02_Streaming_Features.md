...
Features updated continuously from Kafka, Pub/Sub, or Kinesis event streams. This topic is part of **08.05 Feature Store Architecture** under `05_Feature_Engineering`.
...
Extend this diagram for `Streaming Features`-specific components, storage engines, and control-plane integrations as the topic is elaborated.

## Related

- [Streaming Feature Store](../03_Architectural_Patterns/04_Streaming_Feature_Store.md)
