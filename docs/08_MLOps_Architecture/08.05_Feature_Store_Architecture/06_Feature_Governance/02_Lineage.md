...
End-to-end traceability from source tables and streams to served feature values. This topic is part of **08.05 Feature Store Architecture** under `06_Feature_Governance`.
...
Extend this diagram for `Feature Lineage`-specific components, storage engines, and control-plane integrations as the topic is elaborated.

## Related

- [Feature Lineage](../../01_ML_Lifecycle/Feature_Lineage.md)
- [Quality](03_Quality.md)
