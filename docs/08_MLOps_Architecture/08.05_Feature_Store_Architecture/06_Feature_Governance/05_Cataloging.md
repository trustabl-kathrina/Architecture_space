...
Discoverability, search, documentation, and consumption APIs for feature consumers. This topic is part of **08.05 Feature Store Architecture** under `06_Feature_Governance`.
...
Extend this diagram for `Feature Cataloging`-specific components, storage engines, and control-plane integrations as the topic is elaborated.

## Related

- [Feature Catalog](../../01_ML_Lifecycle/Feature_Catalog.md)
