...
Logical bundles of related features sharing entity, freshness, and ownership boundaries. This topic is part of **08.05 Feature Store Architecture** under `02_Core_Concepts`.
...
Extend this diagram for `Feature Groups`-specific components, storage engines, and control-plane integrations as the topic is elaborated.

## Related

- [Feature Sets](04_Feature_Sets.md)
