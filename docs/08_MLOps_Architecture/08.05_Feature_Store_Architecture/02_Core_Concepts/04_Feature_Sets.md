...
Curated collections of features selected for a model family or use case. This topic is part of **08.05 Feature Store Architecture** under `02_Core_Concepts`.
...
Extend this diagram for `Feature Sets`-specific components, storage engines, and control-plane integrations as the topic is elaborated.
