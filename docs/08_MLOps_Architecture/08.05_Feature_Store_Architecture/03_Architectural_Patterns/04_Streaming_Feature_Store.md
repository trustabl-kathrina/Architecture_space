...
Continuous feature computation from event streams into online and archival offline stores. This topic is part of **08.05 Feature Store Architecture** under `03_Architectural_Patterns`.
...
Extend this diagram for `Streaming Feature Store`-specific components, storage engines, and control-plane integrations as the topic is elaborated.

## Related

- [Streaming Features](../05_Feature_Engineering/02_Streaming_Features.md)
- [Aggregation Patterns](../05_Feature_Engineering/03_Aggregation_Patterns.md)
