...
AWS managed online/offline feature store for SageMaker training and endpoints. This topic is part of **08.05 Feature Store Architecture** under `07_Cloud_Implementations`.
...
Extend this diagram for `SageMaker Feature Store`-specific components, storage engines, and control-plane integrations as the topic is elaborated.

## Related

- [AWS Reference](../10_Reference_Architectures/02_AWS_Reference.md)
