...
For hands-on depth — usage, scenarios, limits, costing, configuration recipes, evaluation criteria, and benchmarks — see the [Pub/Sub Learning Guide](09.02.02.04_Pub_Sub_Learning_Guide/README.md).

## Related

- [Cloud Streaming Reference Architecture](../09.02.01_Overview/09.02.01.01_Cloud_Streaming_Reference_Architecture.md)
...
- [GCP Pub/Sub POC](09.02.02.03_GCP_PubSub_POC.md)
- [Pub/Sub vs Kafka](../../09.06_Comparisons/09.06.04_Pub_Sub_vs_Kafka.md)
