...
- Long-running business processes with compensations ([Saga Pattern](09.04.03_Integration_Patterns/09.04.03.02_Saga_Pattern.md)).
...
- [Saga Pattern](../09.04.03_Integration_Patterns/09.04.03.02_Saga_Pattern.md)
- [Event Driven Microservices](../../09.08_Integration_Patterns/09.08.08_Event_Driven_Microservices.md)
