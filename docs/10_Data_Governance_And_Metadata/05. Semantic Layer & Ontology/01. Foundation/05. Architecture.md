...
| Versioning | Immutable versions + current pointer |
...
| Capability | Notes |
| --- | --- |
| Hierarchy | `global` + `natco-{code}` (or country scopes) |
| Ownership / scope | Who may edit |
| Visibility | Publish and discovery boundaries |
...
Detail (when authored): [03. Enterprise Knowledge Graph](../03.%20Enterprise%20Knowledge%20Graph/).
...
| --- | --- | --- |
| Business term | Concept | Business mapping |
| Technical table / column | Concept | Technical mapping |
| Marketplace product | Concept | Product mapping |

Supports confidence scoring. See [Business](../05.%20Enterprise%20Mapping/01.%20Business%20Mapping.md) / [Technical](../05.%20Enterprise%20Mapping/02.%20Technical%20Mapping.md) / [Data Product](../05.%20Enterprise%20Mapping/03.%20Data%20Product%20Mapping.md) mapping.
...
| Quality | Conflict detection, harmonization |

Product binding rule (Marketplace enrichment): Global products → `global/*`; NATCO products → **`global/*` required** where applicable + **`natco-*/*` optional**. See [Multi-NATCO Federation](07.%20Multi-NATCO%20Federation.md).
