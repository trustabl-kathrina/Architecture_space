...
```powershell
python -m venv ..\doc-factory\.venv
..\doc-factory\.venv\Scripts\Activate.ps1
pip install -e .[dev]
```
...
Chat agent architecture: see [`docs/product/KEW_CHAT_AGENT_FLOW.md`](../../docs/product/KEW_CHAT_AGENT_FLOW.md).
