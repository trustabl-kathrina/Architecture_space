...
# Top 10 slot map (see 01_Top_10_Orchestration_Technologies.md):
...
SPECS = [
    ("02_Apache_Airflow_Learning_Guide", AIRFLOW),
    ("03_Prefect_Learning_Guide", PREFECT),
    ("04_Dagster_Learning_Guide", DAGSTER),
    ("05_Temporal_Learning_Guide", TEMPORAL),
    ("06_Argo_Workflows_Learning_Guide", ARGO),
]
...
def main():
    ...
    for folder, blocks in SPECS:
        sec = folder.split("_")[0]  # e.g. 02.03.03.02 from 02_Apache_Airflow_Learning_Guide
